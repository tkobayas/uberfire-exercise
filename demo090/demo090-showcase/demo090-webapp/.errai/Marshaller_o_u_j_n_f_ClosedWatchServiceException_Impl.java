...
public class Marshaller_o_u_j_n_f_ClosedWatchServiceException_Impl implements GeneratedMarshaller<ClosedWatchServiceException> {
  ...
  public ClosedWatchServiceException demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(ClosedWatchServiceException.class, objId);
    }
    ClosedWatchServiceException entity = new ClosedWatchServiceException();
  ...
  public String marshall(ClosedWatchServiceException a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.uberfire.java.nio.file.ClosedWatchServiceException\",\"^ObjectID\"");
