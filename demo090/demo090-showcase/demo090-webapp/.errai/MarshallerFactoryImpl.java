...
@Dependent public class MarshallerFactoryImpl implements MarshallerFactory {
  ...
  abstract class Marshaller_for_org_uberfire_component_model_MyModel implements GeneratedMarshaller { }
  ...
  public Marshaller getMarshaller(String a0) {
    ...
    Marshaller m = null;
    if (a0.equals("java.lang.Throwable")) {
    ...
    } else if (a0.equals("java.lang.StackTraceElement")) {
    ...
    } else if (a0.equals("org.uberfire.component.model.MyModel")) {
      m = GWT.create(Marshaller_for_org_uberfire_component_model_MyModel.class);
