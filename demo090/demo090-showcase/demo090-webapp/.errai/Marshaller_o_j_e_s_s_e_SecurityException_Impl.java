...
public class Marshaller_o_j_e_s_s_e_SecurityException_Impl implements GeneratedMarshaller<SecurityException> {
  ...
  public SecurityException demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(SecurityException.class, objId);
    }
    final String c0 = java_lang_String.demarshall(obj.get("message"), a1);
    SecurityException entity = new SecurityException(c0);
  ...
  public String marshall(SecurityException a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.jboss.errai.security.shared.exception.SecurityException\",\"^ObjectID\"");
