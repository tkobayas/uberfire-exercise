...
public class Marshaller_o_u_j_n_f_FileSystemException_Impl implements GeneratedMarshaller<FileSystemException> {
  ...
  public FileSystemException demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(FileSystemException.class, objId);
    }
    final String c0 = java_lang_String.demarshall(obj.get("message"), a1);
    FileSystemException entity = new FileSystemException(c0);
  ...
  public String marshall(FileSystemException a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.uberfire.java.nio.file.FileSystemException\",\"^ObjectID\"");
