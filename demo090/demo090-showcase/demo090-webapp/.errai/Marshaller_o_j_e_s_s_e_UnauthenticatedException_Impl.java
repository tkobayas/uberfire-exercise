...
public class Marshaller_o_j_e_s_s_e_UnauthenticatedException_Impl implements GeneratedMarshaller<UnauthenticatedException> {
  ...
  public UnauthenticatedException demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(UnauthenticatedException.class, objId);
    }
    final String c0 = java_lang_String.demarshall(obj.get("message"), a1);
    UnauthenticatedException entity = new UnauthenticatedException(c0);
  ...
  public String marshall(UnauthenticatedException a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.jboss.errai.security.shared.exception.UnauthenticatedException\",\"^ObjectID\"");
