...
public class Marshaller_o_u_j_n_f_FileSystemAlreadyExistsException_Impl implements GeneratedMarshaller<FileSystemAlreadyExistsException> {
  ...
  public FileSystemAlreadyExistsException demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(FileSystemAlreadyExistsException.class, objId);
    }
    final String c0 = java_lang_String.demarshall(obj.get("message"), a1);
    FileSystemAlreadyExistsException entity = new FileSystemAlreadyExistsException(c0);
  ...
  public String marshall(FileSystemAlreadyExistsException a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.uberfire.java.nio.file.FileSystemAlreadyExistsException\",\"^ObjectID\"");
