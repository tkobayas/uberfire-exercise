...
public class Marshaller_o_u_j_n_IOException_Impl implements GeneratedMarshaller<IOException> {
  ...
  public String marshall(IOException a0, MarshallingSession a1) {
    ...
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.uberfire.java.nio.IOException\",\"^ObjectID\"");
