...
public class Marshaller_o_j_e_s_s_e_AuthenticationException_Impl implements GeneratedMarshaller<AuthenticationException> {
  ...
  public String marshall(AuthenticationException a0, MarshallingSession a1) {
    ...
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.jboss.errai.security.shared.exception.AuthenticationException\",\"^ObjectID\"");
