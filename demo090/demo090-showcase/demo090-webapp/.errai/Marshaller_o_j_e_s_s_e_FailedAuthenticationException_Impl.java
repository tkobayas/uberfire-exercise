...
public class Marshaller_o_j_e_s_s_e_FailedAuthenticationException_Impl implements GeneratedMarshaller<FailedAuthenticationException> {
  ...
  public FailedAuthenticationException demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(FailedAuthenticationException.class, objId);
    }
    final String c0 = java_lang_String.demarshall(obj.get("message"), a1);
    FailedAuthenticationException entity = new FailedAuthenticationException(c0);
  ...
  public String marshall(FailedAuthenticationException a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.jboss.errai.security.shared.exception.FailedAuthenticationException\",\"^ObjectID\"");
