...
public class Marshaller_o_u_j_n_f_PatternSyntaxException_Impl implements GeneratedMarshaller<PatternSyntaxException> {
  ...
  public PatternSyntaxException demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(PatternSyntaxException.class, objId);
    }
    PatternSyntaxException entity = new PatternSyntaxException();
  ...
  public String marshall(PatternSyntaxException a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.uberfire.java.nio.file.PatternSyntaxException\",\"^ObjectID\"");
