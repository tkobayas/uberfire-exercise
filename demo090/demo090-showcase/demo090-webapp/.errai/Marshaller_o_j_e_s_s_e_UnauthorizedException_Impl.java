...
public class Marshaller_o_j_e_s_s_e_UnauthorizedException_Impl implements GeneratedMarshaller<UnauthorizedException> {
  ...
  public UnauthorizedException demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(UnauthorizedException.class, objId);
    }
    final String c0 = java_lang_String.demarshall(obj.get("message"), a1);
    UnauthorizedException entity = new UnauthorizedException(c0);
  ...
  public String marshall(UnauthorizedException a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.jboss.errai.security.shared.exception.UnauthorizedException\",\"^ObjectID\"");
