...
public class Marshaller_o_u_j_n_f_AccessDeniedException_Impl implements GeneratedMarshaller<AccessDeniedException> {
  ...
  public AccessDeniedException demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(AccessDeniedException.class, objId);
    }
    final String c0 = java_lang_String.demarshall(obj.get("message"), a1);
    AccessDeniedException entity = new AccessDeniedException(c0);
  ...
  public String marshall(AccessDeniedException a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.uberfire.java.nio.file.AccessDeniedException\",\"^ObjectID\"");
