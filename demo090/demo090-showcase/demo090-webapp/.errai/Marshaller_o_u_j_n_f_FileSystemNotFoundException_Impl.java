...
public class Marshaller_o_u_j_n_f_FileSystemNotFoundException_Impl implements GeneratedMarshaller<FileSystemNotFoundException> {
  ...
  public FileSystemNotFoundException demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(FileSystemNotFoundException.class, objId);
    }
    final String c0 = java_lang_String.demarshall(obj.get("message"), a1);
    FileSystemNotFoundException entity = new FileSystemNotFoundException(c0);
  ...
  public String marshall(FileSystemNotFoundException a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.uberfire.java.nio.file.FileSystemNotFoundException\",\"^ObjectID\"");
