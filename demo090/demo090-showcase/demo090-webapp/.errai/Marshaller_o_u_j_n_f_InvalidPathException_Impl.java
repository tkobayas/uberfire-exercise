...
public class Marshaller_o_u_j_n_f_InvalidPathException_Impl implements GeneratedMarshaller<InvalidPathException> {
  ...
  private native static String _$1078371949__1195259493_input(InvalidPathException instance) /*-{
    return instance.@org.uberfire.java.nio.file.InvalidPathException::input;
  }-*/;

  private native static void _$1078371949__1195259493_input(InvalidPathException instance, String value) /*-{
    instance.@org.uberfire.java.nio.file.InvalidPathException::input = value;
  }-*/;

  private native static String _$1078371949__1195259493_reason(InvalidPathException instance) /*-{
    return instance.@org.uberfire.java.nio.file.InvalidPathException::reason;
  }-*/;

  private native static void _$1078371949__1195259493_reason(InvalidPathException instance, String value) /*-{
    instance.@org.uberfire.java.nio.file.InvalidPathException::reason = value;
  }-*/;

  private native static int _$1078371949__104431_index(InvalidPathException instance) /*-{
    return instance.@org.uberfire.java.nio.file.InvalidPathException::index;
  }-*/;

  private native static void _$1078371949__104431_index(InvalidPathException instance, int value) /*-{
    instance.@org.uberfire.java.nio.file.InvalidPathException::index = value;
  }-*/;
