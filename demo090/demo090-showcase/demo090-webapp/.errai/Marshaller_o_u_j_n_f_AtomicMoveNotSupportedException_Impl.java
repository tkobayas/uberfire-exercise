...
public class Marshaller_o_u_j_n_f_AtomicMoveNotSupportedException_Impl implements GeneratedMarshaller<AtomicMoveNotSupportedException> {
  ...
  public AtomicMoveNotSupportedException demarshall(EJValue a0, MarshallingSession a1) {
    lazyInit();
    ...
    if (a1.hasObject(objId)) {
      return a1.getObject(AtomicMoveNotSupportedException.class, objId);
    }
    AtomicMoveNotSupportedException entity = new AtomicMoveNotSupportedException();
  ...
  public String marshall(AtomicMoveNotSupportedException a0, MarshallingSession a1) {
    lazyInit();
    if (a0 == null) {
      return "null";
    }
    final boolean ref = a1.hasObject(a0);
    final StringBuilder json = new StringBuilder("{\"^EncodedType\":\"org.uberfire.java.nio.file.AtomicMoveNotSupportedException\",\"^ObjectID\"");
